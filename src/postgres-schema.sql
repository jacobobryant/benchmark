...
CREATE INDEX IF NOT EXISTS idx_item_candidate_status ON item(candidate_status);
...
CREATE INDEX IF NOT EXISTS idx_user_item_favorited_at ON user_item(favorited_at);
